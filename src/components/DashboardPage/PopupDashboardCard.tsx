...
export function PopupDashboardCard({ myImg, title, reversedPercentage, dataForPopupChart }: DashboardCardProps) {
    ...
    return (
        <div className="flex flex-col gap-4">
            <DashboardCard myImg={myImg} title={title} reversedPercentage={reversedPercentage} inPopup />
