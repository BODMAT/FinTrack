...
export const DebouncedSearchInput = ({
  ...
  return (
    <input
      ...
      className="bg-(--color-card) rounded-[10px] p-[10px] w-[300px] border border-(--color-fixed-text) text-(--color-text) transitioned hover:border-(--color-hover) text-[16px] font-semibold"
    />
  );
};
