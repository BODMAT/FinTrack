...
export function TransactionsCard({ data }: { data: IData }) {
    ...
    const handleOpenChange = (id: string) => () => open("Change transaction", <ChangeTransactionPopup id={id} />);
    const handleOpenDelete = (id: string) => () => open("Delete transaction", <DeleteTransactionPopup id={id} />);
    return (
        <div
        ...
        >
            ...
            <span
                className="col-span-2 max-[1000px]:col-span-1 justify-self-center px-2 break-words whitespace-normal text-center"
            >
            ...
            <span className="text-center col-span-2 max-[1300px]:col-span-1 justify-self-center px-2 break-words whitespace-normal">{data.location ? `${data.location.latitude.toFixed(3)}, ${data.location.longitude.toFixed(3)}` : "No location"}</span>
